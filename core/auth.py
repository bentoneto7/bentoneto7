...
def login(username: str, password: str) -> dict:
    ...
    try:
        ...
        # Save the loader context for 2FA step
        return {"success": False, "needs_2fa": True, "error": None, "_loader": L}
...
def login_2fa(loader: instaloader.Instaloader, username: str, code: str) -> dict:
    """Complete 2FA login with the code.
    ...
    try:
        ...
        loader.save_session_to_file(filename=_get_session_path(username))
